...
|---|---|---|---|---|---|
| `version_plataforma` | ARHIAX RE v1.4.0 · commit 7a49762f · dictus v1.4.0 · GIS v1.2.0 · Titulux v1.1.0 · reglas v1.3.0 | versioning.VERSION_MATRIX + git rev-parse HEAD | VERIFIED_CODE | 7a49762f | pie de página, 16.b |
| `commit_sha` | 7a49762ffa97222ad1b5d30d92572b1d8ad1c9ef | git rev-parse HEAD | VERIFIED_CODE | 03I.1 §A | pie de página, 16.b |
...
| `identidad_confianza` | VERIFIED_UNIT_IDENTITY | OFFICIAL_ADOPTION_REGISTRY | MATCH_EXACT | 03G.1 | 01, 05, 06, 16 |
| `direccion_canonica` | Transversal 43 100 50 TO 8 AP 430 | OFFICIAL_ADOPTION_REGISTRY | VERIFIED_OFFICIAL | 03I.1 F5 | 01, 02, 16 |
| `unidad_canonica` | torre=8 ap=430 unidad=TO 8 AP 430 | modelo canónico (complemento declarado) | VERIFIED_OFFICIAL | 03I.1 F5 | 01, 09 rol |
...
| `destino_economico_render` | None | servicio catastral (capa 500 / destinos económicos) | UNRESOLVED | 03H.2A | 06.1, 07 uso |
...
| `poi_categorias` | {"Comercio": {"status": "NO_MATCH", "items": 0, "fuentes": []}, "Educacion": {"status": "AVAILABLE", "items": 2, "fuentes": ["PHOTON_OSM"]}, "Recreacion": {"status": "NO_MATCH", "items": 0, "fuentes": []}, "Salud": {"status": "AVAILABLE", "items": 3, "fuentes": ["PHOTON_OSM"]}} | OSM/Overpass + Photon · intentadas=['OSM_OVERPASS', 'PHOTON_OSM'] · exitosas=['PHOTON_OSM'] | OBSERVED | 03F | 03, 16.b |
